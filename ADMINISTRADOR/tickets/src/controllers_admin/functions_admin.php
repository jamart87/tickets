...
function users($list, $list2 = null)
{
   ...
   foreach ($list2 as $key) {
     ...
     $html.='<td>'.$key['rol'].'</td>';
     $html.='<td></td>';
     $html.='<td> <span class="btn btn-info btn-small" id="'.$key['id'].'" onClick="editar_user2(this.id)" title="Editar"><i class="icon-edit"></i></span>
      <span class="btn btn-danger btn-small" id="'.$key['id'].'" onClick="eliminar_user2(this.id)" title="Eliminar"><i class="icon-remove"></i></span>';
