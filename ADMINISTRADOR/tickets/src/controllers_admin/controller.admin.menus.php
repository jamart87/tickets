...
$app->match('/deleteEvento', function () use ($app, $admin,$prefix,$modelmenus,$logError) {     
        ...
        $id=$_POST['id'];   
				...
				if ($redirect->redirect ){
					return $app->redirect( $url.$redirect->url);	
				     ...
				     $delete = $modelmenus->_deleteEvento($app,$id,$prefix,$logError);
					 if($delete!=NULL) {
                	   $result['msg'] = 'Evento Eliminado Correctamente';
              		   $result['response'] = true;	
              		 }
              		 else {
                	  $result['msg'] = 'Error al Eliminar el Evento';
